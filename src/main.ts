...
const handleFashionShop = () => {
    WA.room.area.onEnter('entryShop').subscribe(() => {
        currentPopup = WA.ui.openPopup("welcomeNote", "Welcome to Top Fashion shop where fashion dreams meet reality", []);
    })
